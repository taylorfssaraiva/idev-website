    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-width section-padding text-center">
        ...
        >
          ...
          >
            Senior Software Engineer specializing in full-stack development, database optimization, 
            and scalable cloud solutions. Transform your business with high-performance applications 
            built using cutting-edge technologies and industry best practices.
          </motion.p>
